...
#print('生成的随机图为:：')
#MyGraph.show_list()
#print('分别检查寻找一条路径、寻找所有路径、寻找最短路径算法，顶点编号为0-N')
#i = 1
#while i:
#    str = input('输入起点：')
#    start = int(str)
#    str = input('输入终点：')
#    end = int(str)
#    path = MyGraph.find_path(start,end)
#    print('一条路径为：',path)
#    path = MyGraph.find_all_paths(start,end)
#    print('所有路径为：',path)
#    path = MyGraph.find_shortest_path(start,end)
#    print('最短路径为：',path)
#    str = input('输入0结束，1继续：')
#    i = int(str)
